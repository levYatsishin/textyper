...
There’s no way to type LaTeX as naturally as handwriting(or faster) without snippets and other IDE-style helpers.

Read more in **TODO** (further reading) 
### Hints
...
- better snippets support
    - fix small bugs here and there in obsidian-ls
    - nvim integration (LuaSnip, vim-vsnip, nvim-snippy, mini.snippets, UltiSnips)
- export all user related data
- section with useful links and further reading
- tauri
- other strange ideas
    - symbols library as a separate page
    - gamefication mode. add rarity to formulas and probability of them appearing (for the first time / after they appeared once). with fancy collors and little effects. bestiary/collection
    - lean/agda integration 
## Motivation
...
So I thought that maybe doing math entirely on a computer will be more fun and convenient. But first there is a need to master the technique.
## Further reading
**TODO**
## Contributing
Ideas and improvements are always welcome via issues, PRs or even direct messages. I really need your feedback to polish remaing rough edges. 
## Run it yourself 
```bash
